...
Spendly expense tracker. Always follow the rules in OPENCODE.md.
...
- `OPENCODE.md` — roadmap, conventions, schema
...
Check `OPENCODE.md` to confirm the requested step is not already
